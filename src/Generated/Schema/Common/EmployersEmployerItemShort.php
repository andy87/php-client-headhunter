 ...
 */
class EmployersEmployerItemShort extends AbstractSchemaModel
{
    protected const FIELD_MAP = ['alternate_url' => 'alternate_url', 'id' => 'id', 'logo_urls' => 'logo_urls', 'name' => 'name', 'url' => 'url', 'vacancies_url' => 'vacancies_url'];

    protected const REQUIRED_FIELDS = ['id', 'name', 'url', 'alternate_url', 'vacancies_url'];
