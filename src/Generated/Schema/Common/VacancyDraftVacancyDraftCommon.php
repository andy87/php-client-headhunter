...
/**
 * OpenAPI schema модель HeadHunter VacancyDraftVacancyDraftCommon.
 */
class VacancyDraftVacancyDraftCommon extends AbstractSchemaModel
{
    ...
    protected const REQUIRED_FIELDS = ['name', 'description', 'key_skills', 'accept_handicapped', 'accept_kids', 'experience', 'response_letter_required', 'type', 'billing_type', 'allow_messages', 'driver_license_types', 'accept_incomplete_resumes', 'professional_roles', 'manager', 'languages', 'response_notifications', 'has_test'];
