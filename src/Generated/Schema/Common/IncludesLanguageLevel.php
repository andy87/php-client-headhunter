...
class IncludesLanguageLevel extends AbstractSchemaModel
{
    ...
    /** @var \and_y87\ClientsHh\Generated\Schema\Common\IncludesIdName Уровень владения. Возможные значения элементов приведены в поле `language_level` [справочника полей](#tag/Obshie-spravochniki/operation/get-dictionaries) */
    public \and_y87\ClientsHh\Generated\Schema\Common\IncludesIdName $level;
}
