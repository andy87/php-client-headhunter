...
/**
 * OpenAPI schema модель HeadHunter ResumeObjectsMetroLine.
 */
class ResumeObjectsMetroLine extends AbstractSchemaModel
{
    protected const FIELD_MAP = ['hex_color' => 'hex_color', 'id' => 'id', 'name' => 'name'];

    protected const REQUIRED_FIELDS = ['id', 'hex_color', 'name'];
