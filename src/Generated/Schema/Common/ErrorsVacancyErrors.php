...
class ErrorsVacancyErrors extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['errors' => [\and_y87\ClientsHh\Generated\Schema\Common\ErrorsVacancyError::class]];

    /** @var string Идентификатор запроса */
    public string $request_id;

    /** @var array<int, \and_y87\ClientsHh\Generated\Schema\Common\ErrorsVacancyError> Массив с данными ошибок */
    public array $errors;
}
