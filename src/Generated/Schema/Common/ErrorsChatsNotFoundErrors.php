...
class ErrorsChatsNotFoundErrors extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['errors' => [\Andy87\ClientsHh\Generated\Schema\Common\ErrorsChatsNotFoundError::class]];

    /** @var string Идентификатор запроса */
    public string $request_id;

    /** @var array<int, \Andy87\ClientsHh\Generated\Schema\Common\ErrorsChatsNotFoundError> Массив с данными ошибок */
    public array $errors;
}
