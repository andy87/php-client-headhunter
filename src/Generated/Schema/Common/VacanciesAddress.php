...
/**
 * OpenAPI schema модель HeadHunter VacanciesAddress.
 */
class VacanciesAddress extends AbstractSchemaModel
{
    protected const FIELD_MAP = ['building' => 'building', 'city' => 'city', 'description' => 'description', 'id' => 'id', 'lat' => 'lat', 'lng' => 'lng', 'metro' => 'metro', 'metro_stations' => 'metro_stations', 'rawData' => 'raw', 'street' => 'street', 'show_metro_only' => 'show_metro_only'];

    protected const REQUIRED_FIELDS = [];

    protected const NULLABLE_FIELDS = ['building', 'city', 'description', 'id', 'lat', 'lng', 'metro', 'rawData', 'street', 'show_metro_only'];
