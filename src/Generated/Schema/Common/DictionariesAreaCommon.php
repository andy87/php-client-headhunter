...
/**
 * OpenAPI schema модель HeadHunter DictionariesAreaCommon.
 */
class DictionariesAreaCommon extends AbstractSchemaModel
{
    protected const FIELD_MAP = ['id' => 'id', 'lat' => 'lat', 'lng' => 'lng', 'name' => 'name', 'name_prepositional' => 'name_prepositional', 'parent_id' => 'parent_id', 'utc_offset' => 'utc_offset'];
