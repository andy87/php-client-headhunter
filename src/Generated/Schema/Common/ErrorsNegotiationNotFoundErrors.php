...
class ErrorsNegotiationNotFoundErrors extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['errors' => [\Andy87\ClientsHh\Generated\Schema\Common\ErrorsNegotiationNotFoundError::class]];
    ...
    /** @var array<int, \Andy87\ClientsHh\Generated\Schema\Common\ErrorsNegotiationNotFoundError> Массив с данными ошибок */
    public array $errors;
}
