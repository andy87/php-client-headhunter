...
class ErrorsEmployerManagerBadArgumentErrors extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['errors' => [\Andy87\ClientsHh\Generated\Schema\Common\ErrorsEmployerManagerBadArgumentError::class]];

    /** @var string Идентификатор запроса */
    public string $request_id;

    /** @var array<int, \Andy87\ClientsHh\Generated\Schema\Common\ErrorsEmployerManagerBadArgumentError> Массив с данными ошибок */
    public array $errors;
}
