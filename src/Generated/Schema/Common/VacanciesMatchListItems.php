...
class VacanciesMatchListItems extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['items' => [\Andy87\ClientsHh\Generated\Schema\Common\VacanciesMatchListItem::class]];

    /** @var array<int, \Andy87\ClientsHh\Generated\Schema\Common\VacanciesMatchListItem> Список вакансий, подходящих под резюме */
    public array $items;
