...
class VacancyCreateFields extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['area' => \and_y87\ClientsHh\Generated\Schema\Common\VacancyArea::class, 'billing_type' => \and_y87\ClientsHh\Generated\Schema\Common\VacancyDeprecatedBillingType::class, 'description' => \and_y87\ClientsHh\Generated\Schema\Common\VacancyDescription::class, 'name' => \and_y87\ClientsHh\Generated\Schema\Common\VacancyName::class, 'type' => \and_y87\ClientsHh\Generated\Schema\Common\VacancyDeprecatedType::class];
    ...
    /** @var \and_y87\ClientsHh\Generated\Schema\Common\VacancyDeprecatedBillingType Заменён на параметр [vacancy_properties](#tag/Uslugi-rabotodatelya/operation/get-vacancy-available-services-list), если передать vacancy_properties, то значение данного поля будет проигнорировано */
 ...
 */
    ...
    /** @var \and_y87\ClientsHh\Generated\Schema\Common\VacancyDeprecatedType Значение open/close заменены на closed_for_applicants, а anonymous,direct - на vacancy_properties (HH_ANONYMOUS, HH_ADVERTISING) */
    public \and_y87\ClientsHh\Generated\Schema\Common\VacancyDeprecatedType $type;
}
