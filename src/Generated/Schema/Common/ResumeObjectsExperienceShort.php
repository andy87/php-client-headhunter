...
/**
 * OpenAPI schema модель HeadHunter ResumeObjectsExperienceShort.
 */
class ResumeObjectsExperienceShort extends AbstractSchemaModel
{
    ...
    /** @var array<int, \and_y87\ClientsHh\Generated\Schema\Common\IncludesIdName> Список отраслей компании. Возможные значения приведены в [справочнике индустрий](#tag/Obshie-spravochniki/operation/get-industries) */
