...
enum ProviderKey: string
{
    ...
    case ApplicantNegotiations = 'applicantNegotiations';
    case Chats = 'chats';
    case ClickmeStatistics = 'clickmeStatistics';
    case CommonReferenceData = 'commonReferenceData';
    case CompanySuggestions = 'companySuggestions';
    ...
    case KeywordSuggestions = 'keywordSuggestions';
    case ManagerInfo = 'managerInfo';
    case OAuth = 'oauth';
    case ResumeDetails = 'resumeDetails';
    case ResumeReferenceData = 'resumeReferenceData';
    case ResumeSearch = 'resumeSearch';
    case SalaryAnalytics = 'salaryAnalytics';
    case SalaryReferenceData = 'salaryReferenceData';
    case SavedResumeSearches = 'savedResumeSearches';
    case Suggestions = 'suggestions';
    case TokenManagement = 'tokenManagement';
    case VacancyDetails = 'vacancyDetails';
