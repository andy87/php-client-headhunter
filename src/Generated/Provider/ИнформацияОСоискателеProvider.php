 ...
 * @property-read ИнформацияОСоискателе\CurrentProvider $current
 *
 */
class ИнформацияОСоискателеProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'current' => ИнформацияОСоискателе\CurrentProvider::class,
    ];
    ...
    {
        /** @var ИнформацияОСоискателе\CurrentProvider $group */
