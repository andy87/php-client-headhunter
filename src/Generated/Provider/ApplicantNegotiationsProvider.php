 ...
 * @property-read ApplicantNegotiations\NegotiationProvider $negotiation
 * @property-read ApplicantNegotiations\NegotiationsProvider $negotiations
 *
 */
class ApplicantNegotiationsProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'negotiation' => ApplicantNegotiations\NegotiationProvider::class,
        'negotiations' => ApplicantNegotiations\NegotiationsProvider::class,
    ];
    ...
    {
        /** @var ApplicantNegotiations\NegotiationProvider $group */
    ...
    {
        /** @var ApplicantNegotiations\NegotiationsProvider $group */
