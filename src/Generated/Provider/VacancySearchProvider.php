 ...
 * @property-read VacancySearch\VacanciesProvider $vacancies
 *
 */
class VacancySearchProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'vacancies' => VacancySearch\VacanciesProvider::class,
    ];
    ...
    {
        /** @var VacancySearch\VacanciesProvider $group */
