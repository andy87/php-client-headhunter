 ...
 * @property-read СправочникиБанкаДанныхЗаработныхПлат\SalaryProvider $salary
 *
 */
class СправочникиБанкаДанныхЗаработныхПлатProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'salary' => СправочникиБанкаДанныхЗаработныхПлат\SalaryProvider::class,
    ];
    ...
    {
        /** @var СправочникиБанкаДанныхЗаработныхПлат\SalaryProvider $group */
