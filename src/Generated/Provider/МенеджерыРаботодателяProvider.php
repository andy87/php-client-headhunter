 ...
 * @property-read МенеджерыРаботодателя\EmployerProvider $employer
 * @property-read МенеджерыРаботодателя\ManagerProvider $manager
 *
 */
class МенеджерыРаботодателяProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'employer' => МенеджерыРаботодателя\EmployerProvider::class,
        'manager' => МенеджерыРаботодателя\ManagerProvider::class,
    ];
    ...
    {
        /** @var МенеджерыРаботодателя\EmployerProvider $group */
    ...
    {
        /** @var МенеджерыРаботодателя\ManagerProvider $group */
