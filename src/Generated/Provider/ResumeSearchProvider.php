...
use and_y87\ClientsHh\Generated\Prompt\SearchForResumesPrompt;
use and_y87\ClientsHh\Generated\Response\SearchForResumesResponse;

/**
 * Provider раздела HeadHunter API "Поиск резюме".
 * @property-read ResumeSearch\ForValueProvider $forValue
 *
 */
class ResumeSearchProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'forValue' => ResumeSearch\ForValueProvider::class,
    ];
     ...
     *
     * @return SearchForResumesResponse DTO ответа.
     *
     * @throws \InvalidArgumentException Если Prompt невалиден.
     * @throws \RuntimeException Если запрос или авторизация завершились ошибкой.
     * @throws \UnexpectedValueException Если обязательные поля успешного ответа отсутствуют.
     */
    public function searchForResumes(SearchForResumesPrompt $prompt): SearchForResumesResponse
    {
        /** @var ResumeSearch\ForValueProvider $group */
        $group = $this->operationGroup('forValue');

        return $group->searchResumes($prompt);
    }
}
