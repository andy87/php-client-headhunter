 ...
 * @property-read ResumeView\GetProvider $get
 *
 */
class ResumeViewProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'get' => ResumeView\GetProvider::class,
    ];
    ...
    {
        /** @var ResumeView\GetProvider $group */
