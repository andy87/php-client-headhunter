...
use Andy87\ClientsHh\Generated\Response\GetResumeResponse;

/**
 * Provider раздела HeadHunter API "Просмотр резюме".
 * @property-read ПросмотрРезюме\GetProvider $get
 *
 */
class ПросмотрРезюмеProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'get' => ПросмотрРезюме\GetProvider::class,
    ];
    ...
    {
        /** @var ПросмотрРезюме\GetProvider $group */
