...
namespace Andy87\ClientsHh\Generated\Provider\БанкДанныхОЗарплатах;

use Andy87\ClientsHh\BaseHhProvider;
use Andy87\ClientsHh\Generated\Prompt\GetSalaryEvaluationPrompt;
use Andy87\ClientsHh\Generated\Response\БанкДанныхОЗарплатах\Salary\GetEvaluationResponse;
...
class SalaryProvider extends BaseHhProvider
{
     ...
     *
     * @return GetEvaluationResponse DTO ответа.
     *
     * @throws \InvalidArgumentException Если Prompt невалиден.
     * @throws \RuntimeException Если запрос или авторизация завершились ошибкой.
     * @throws \UnexpectedValueException Если обязательные поля успешного ответа отсутствуют.
     */
    public function getEvaluation(GetSalaryEvaluationPrompt $prompt): GetEvaluationResponse
    {
        /** @var GetEvaluationResponse $response */
        $response = $this->request($prompt, GetEvaluationResponse::class);
