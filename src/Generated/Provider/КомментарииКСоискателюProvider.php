 ...
 * @property-read КомментарииКСоискателю\ApplicantProvider $applicant
 *
 */
class КомментарииКСоискателюProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'applicant' => КомментарииКСоискателю\ApplicantProvider::class,
    ];
    ...
    {
        /** @var КомментарииКСоискателю\ApplicantProvider $group */
