...
use Andy87\ClientsHh\Generated\Response\GetPayableApiActionsResponse;
use Andy87\ClientsHh\Generated\Response\GetPayableApiMethodAccessResponse;
use Andy87\ClientsHh\Generated\Response\GetVacancyAvailableServicesListResponse;

/**
 * Provider раздела HeadHunter API "Услуги работодателя".
 * @property-read УслугиРаботодателя\PayableProvider $payable
 * @property-read УслугиРаботодателя\VacancyProvider $vacancy
 *
 */
class УслугиРаботодателяProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'payable' => УслугиРаботодателя\PayableProvider::class,
        'vacancy' => УслугиРаботодателя\VacancyProvider::class,
    ];
    ...
    {
        /** @var УслугиРаботодателя\PayableProvider $group */
    ...
    {
        /** @var УслугиРаботодателя\VacancyProvider $group */
