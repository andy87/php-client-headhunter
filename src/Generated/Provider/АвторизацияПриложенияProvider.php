 ...
 * @property-read АвторизацияПриложения\GeneralProvider $general
 *
 */
class АвторизацияПриложенияProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'general' => АвторизацияПриложения\GeneralProvider::class,
    ];
    ...
    {
        /** @var АвторизацияПриложения\GeneralProvider $group */
