 ...
 * @property-read EmployerAuthorization\InvalidateProvider $invalidate
 *
 */
class EmployerAuthorizationProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'invalidate' => EmployerAuthorization\InvalidateProvider::class,
    ];
    ...
    {
        /** @var EmployerAuthorization\InvalidateProvider $group */
