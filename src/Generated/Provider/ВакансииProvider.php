 ...
 * @property-read Вакансии\VacancyProvider $vacancy
 *
 */
class ВакансииProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'vacancy' => Вакансии\VacancyProvider::class,
    ];
    ...
    {
        /** @var Вакансии\VacancyProvider $group */
