 ...
 * @property-read Chats\ChatProvider $chat
 * @property-read Chats\CommonProvider $common
 * @property-read Chats\LastProvider $last
 * @property-read Chats\LeaveProvider $leave
 * @property-read Chats\OrValueProvider $orValue
 * @property-read Chats\ParticipantProvider $participant
 * @property-read Chats\UnreadProvider $unread
 * @property-read Chats\WriteProvider $write
 *
 */
class ChatsProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'chat' => Chats\ChatProvider::class,
        'common' => Chats\CommonProvider::class,
        'last' => Chats\LastProvider::class,
        'leave' => Chats\LeaveProvider::class,
        'orValue' => Chats\OrValueProvider::class,
        'participant' => Chats\ParticipantProvider::class,
        'unread' => Chats\UnreadProvider::class,
        'write' => Chats\WriteProvider::class,
    ];
    ...
    {
        /** @var Chats\CommonProvider $group */
    ...
    {
        /** @var Chats\OrValueProvider $group */
    ...
    {
        /** @var Chats\ParticipantProvider $group */
    ...
    {
        /** @var Chats\UnreadProvider $group */
