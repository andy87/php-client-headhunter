 ...
 * @property-read ОбщиеСправочники\AllProvider $all
 * @property-read ОбщиеСправочники\AreasProvider $areas
 * @property-read ОбщиеСправочники\CountriesProvider $countries
 * @property-read ОбщиеСправочники\DictionariesProvider $dictionaries
 * @property-read ОбщиеСправочники\IndustriesProvider $industries
 * @property-read ОбщиеСправочники\LanguagesProvider $languages
 * @property-read ОбщиеСправочники\LocalesProvider $locales
 * @property-read ОбщиеСправочники\MetroProvider $metro
 * @property-read ОбщиеСправочники\ProfessionalProvider $professional
 *
 */
class ОбщиеСправочникиProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'all' => ОбщиеСправочники\AllProvider::class,
        'areas' => ОбщиеСправочники\AreasProvider::class,
        'countries' => ОбщиеСправочники\CountriesProvider::class,
        'dictionaries' => ОбщиеСправочники\DictionariesProvider::class,
        'industries' => ОбщиеСправочники\IndustriesProvider::class,
        'languages' => ОбщиеСправочники\LanguagesProvider::class,
        'locales' => ОбщиеСправочники\LocalesProvider::class,
        'metro' => ОбщиеСправочники\MetroProvider::class,
        'professional' => ОбщиеСправочники\ProfessionalProvider::class,
    ];
    ...
    {
        /** @var ОбщиеСправочники\AllProvider $group */
    ...
    {
        /** @var ОбщиеСправочники\AreasProvider $group */
    ...
    {
        /** @var ОбщиеСправочники\CountriesProvider $group */
    ...
    {
        /** @var ОбщиеСправочники\DictionariesProvider $group */
    ...
    {
        /** @var ОбщиеСправочники\IndustriesProvider $group */
    ...
    {
        /** @var ОбщиеСправочники\LanguagesProvider $group */
    ...
    {
        /** @var ОбщиеСправочники\LocalesProvider $group */
    ...
    {
        /** @var ОбщиеСправочники\MetroProvider $group */
    ...
    {
        /** @var ОбщиеСправочники\ProfessionalProvider $group */
