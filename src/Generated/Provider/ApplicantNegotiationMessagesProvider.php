 ...
 * @property-read ApplicantNegotiationMessages\NegotiationProvider $negotiation
 * @property-read ApplicantNegotiationMessages\NegotiationsProvider $negotiations
 *
 */
class ApplicantNegotiationMessagesProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'negotiation' => ApplicantNegotiationMessages\NegotiationProvider::class,
        'negotiations' => ApplicantNegotiationMessages\NegotiationsProvider::class,
    ];
    ...
    {
        /** @var ApplicantNegotiationMessages\NegotiationProvider $group */
    ...
    {
        /** @var ApplicantNegotiationMessages\NegotiationsProvider $group */
