 ...
 * @property-read SalaryDatabase\SalaryProvider $salary
 *
 */
class SalaryDatabaseProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'salary' => SalaryDatabase\SalaryProvider::class,
    ];
    ...
    {
        /** @var SalaryDatabase\SalaryProvider $group */
