 ...
 * @property-read EmployerNegotiations\CollectionProvider $collection
 * @property-read EmployerNegotiations\GetProvider $get
 * @property-read EmployerNegotiations\InviteProvider $invite
 * @property-read EmployerNegotiations\MailProvider $mail
 * @property-read EmployerNegotiations\NegotiationProvider $negotiation
 * @property-read EmployerNegotiations\NegotiationsProvider $negotiations
 * @property-read EmployerNegotiations\PrefProvider $pref
 *
 */
class EmployerNegotiationsProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'collection' => EmployerNegotiations\CollectionProvider::class,
        'get' => EmployerNegotiations\GetProvider::class,
        'invite' => EmployerNegotiations\InviteProvider::class,
        'mail' => EmployerNegotiations\MailProvider::class,
        'negotiation' => EmployerNegotiations\NegotiationProvider::class,
        'negotiations' => EmployerNegotiations\NegotiationsProvider::class,
        'pref' => EmployerNegotiations\PrefProvider::class,
    ];
    ...
    {
        /** @var EmployerNegotiations\NegotiationProvider $group */
    ...
    {
        /** @var EmployerNegotiations\CollectionProvider $group */
    ...
    {
        /** @var EmployerNegotiations\MailProvider $group */
    ...
    {
        /** @var EmployerNegotiations\NegotiationsProvider $group */
    ...
    {
        /** @var EmployerNegotiations\PrefProvider $group */
    ...
    {
        /** @var EmployerNegotiations\GetProvider $group */
    ...
    {
        /** @var EmployerNegotiations\InviteProvider $group */
