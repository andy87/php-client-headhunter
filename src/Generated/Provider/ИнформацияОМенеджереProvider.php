...
use Andy87\ClientsHh\Generated\Response\GetAvailableVacancyTypesResponse;

/**
 * Provider раздела HeadHunter API "Информация о менеджере".
 * @property-read ИнформацияОМенеджере\AvailableProvider $available
 *
 */
class ИнформацияОМенеджереProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'available' => ИнформацияОМенеджере\AvailableProvider::class,
    ];
    ...
    {
        /** @var ИнформацияОМенеджере\AvailableProvider $group */
