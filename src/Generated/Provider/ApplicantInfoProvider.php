 ...
 * @property-read ApplicantInfo\CurrentProvider $current
 *
 */
class ApplicantInfoProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'current' => ApplicantInfo\CurrentProvider::class,
    ];
    ...
    {
        /** @var ApplicantInfo\CurrentProvider $group */
