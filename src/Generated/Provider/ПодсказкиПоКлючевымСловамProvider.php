 ...
 * @property-read ПодсказкиПоКлючевымСловам\GetProvider $get
 * @property-read ПодсказкиПоКлючевымСловам\VacancyProvider $vacancy
 *
 */
class ПодсказкиПоКлючевымСловамProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'get' => ПодсказкиПоКлючевымСловам\GetProvider::class,
        'vacancy' => ПодсказкиПоКлючевымСловам\VacancyProvider::class,
    ];
    ...
    {
        /** @var ПодсказкиПоКлючевымСловам\GetProvider $group */
    ...
    {
        /** @var ПодсказкиПоКлючевымСловам\VacancyProvider $group */
