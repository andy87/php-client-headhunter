 ...
 * @property-read СтатистикаРекламныхКампанийВClickme\ClickmeProvider $clickme
 *
 */
class СтатистикаРекламныхКампанийВClickmeProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'clickme' => СтатистикаРекламныхКампанийВClickme\ClickmeProvider::class,
    ];
    ...
    {
        /** @var СтатистикаРекламныхКампанийВClickme\ClickmeProvider $group */
