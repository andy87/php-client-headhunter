 ...
 */
class WebhookProvider extends BaseHhProvider
{
    /**
     ...
     *
     * @return CancelSubscriptionResponse DTO ответа.
     *
     * @throws \InvalidArgumentException Если Prompt невалиден.
     * @throws \RuntimeException Если запрос или авторизация завершились ошибкой.
     * @throws \UnexpectedValueException Если обязательные поля успешного ответа отсутствуют.
     */
    public function cancelSubscription(CancelWebhookSubscriptionPrompt $prompt): CancelSubscriptionResponse
    {
        /** @var CancelSubscriptionResponse $response */
        $response = $this->request($prompt, CancelSubscriptionResponse::class);
     ...
     *
     * @return ChangeSubscriptionResponse DTO ответа.
     *
     * @throws \InvalidArgumentException Если Prompt невалиден.
     * @throws \RuntimeException Если запрос или авторизация завершились ошибкой.
     * @throws \UnexpectedValueException Если обязательные поля успешного ответа отсутствуют.
     */
    public function changeSubscription(ChangeWebhookSubscriptionPrompt $prompt): ChangeSubscriptionResponse
    {
        /** @var ChangeSubscriptionResponse $response */
        $response = $this->request($prompt, ChangeSubscriptionResponse::class);
     ...
     * @throws \UnexpectedValueException Если обязательные поля успешного ответа отсутствуют.
     */
    public function getSubscriptions(GetWebhookSubscriptionsPrompt $prompt): GetSubscriptionsResponse
    {
        /** @var GetSubscriptionsResponse $response */
        $response = $this->request($prompt, GetSubscriptionsResponse::class);
     ...
     *
     * @return PostSubscriptionResponse DTO ответа.
     *
     * @throws \InvalidArgumentException Если Prompt невалиден.
     * @throws \RuntimeException Если запрос или авторизация завершились ошибкой.
     * @throws \UnexpectedValueException Если обязательные поля успешного ответа отсутствуют.
     */
    public function postSubscription(PostWebhookSubscriptionPrompt $prompt): PostSubscriptionResponse
    {
        /** @var PostSubscriptionResponse $response */
        $response = $this->request($prompt, PostSubscriptionResponse::class);
