 ...
 * @property-read ПоискРезюме\ForValueProvider $forValue
 *
 */
class ПоискРезюмеProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'forValue' => ПоискРезюме\ForValueProvider::class,
    ];
    ...
    {
        /** @var ПоискРезюме\ForValueProvider $group */
