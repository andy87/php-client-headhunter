...
use Andy87\ClientsHh\Generated\Response\GetSalaryEvaluationResponse;

/**
 * Provider раздела HeadHunter API "Банк данных о зарплатах".
 * @property-read БанкДанныхОЗарплатах\SalaryProvider $salary
 *
 */
class БанкДанныхОЗарплатахProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'salary' => БанкДанныхОЗарплатах\SalaryProvider::class,
    ];
    ...
    {
        /** @var БанкДанныхОЗарплатах\SalaryProvider $group */
