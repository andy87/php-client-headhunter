...
use and_y87\ClientsHh\Generated\Response\AuthorizeResponse;

/**
 * Provider раздела HeadHunter API "Авторизация приложения".
 * @property-read OAuth\GeneralProvider $general
 *
 */
class OAuthProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'general' => OAuth\GeneralProvider::class,
    ];
    ...
    {
        /** @var OAuth\GeneralProvider $group */
