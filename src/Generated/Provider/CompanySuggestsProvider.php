 ...
 * @property-read CompanySuggests\RegisteredProvider $registered
 *
 */
class CompanySuggestsProvider extends BaseHhProvider
{
    protected const OPERATION_GROUPS = [
        'registered' => CompanySuggests\RegisteredProvider::class,
    ];
    ...
    {
        /** @var CompanySuggests\RegisteredProvider $group */
