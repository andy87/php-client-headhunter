 ...
 */
class GetAreasPrompt extends PrivatePrompt
{
    protected const METHOD = 'GET';

    protected const ENDPOINT = '/areas';
    ...
    protected const FIELD_MAP = ['additional_case' => 'additional_case', 'host' => 'host', 'locale' => 'locale', 'HH_User_Agent' => 'HH-User-Agent'];
