 ...
 */
class GetSkillSetSuggestsPrompt extends PrivatePrompt
{
    protected const METHOD = 'GET';

    protected const ENDPOINT = '/suggests/skill_set';
    ...
    /** @var string Текст для поиска ключевых навыков. Искомый текст должен быть длиной два или более символа и не более 3 000 символов */
    public string $text;
