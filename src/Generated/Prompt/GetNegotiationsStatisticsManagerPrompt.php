 ...
 */
class GetNegotiationsStatisticsManagerPrompt extends PrivatePrompt
{
    protected const METHOD = 'GET';

    protected const ENDPOINT = '/employers/{employer_id}/managers/{manager_id}/negotiations_statistics';
