 ...
 */
class DeleteEmployerManagerPrompt extends PrivatePrompt
{
    ...
    protected const QUERY_PARAMETER_STYLES = ['successor_id' => ['style' => 'form', 'explode' => true], 'host' => ['style' => 'form', 'explode' => true], 'locale' => ['style' => 'form', 'explode' => true]];

    protected const FIELD_MAP = ['employer_id' => 'employer_id', 'manager_id' => 'manager_id', 'successor_id' => 'successor_id', 'host' => 'host', 'locale' => 'locale', 'HH_User_Agent' => 'HH-User-Agent'];

    protected const REQUIRED_FIELDS = ['employer_id', 'manager_id', 'successor_id'];
    ...
    protected const QUERY_FIELDS = ['successor_id', 'host', 'locale'];
    ...
    /** @var string Идентификатор менеджера, которому передаются данные, связанные с удаляемым менеджером, в частности: вакансии, отклики, папки отобранных резюме, комментарии к соискателю, автопоиски и прочее */
