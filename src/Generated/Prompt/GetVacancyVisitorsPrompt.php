 ...
 */
class GetVacancyVisitorsPrompt extends PrivatePrompt
{
    protected const METHOD = 'GET';

    protected const ENDPOINT = '/vacancies/{vacancy_id}/visitors';
    ...
    protected const FIELD_MAP = ['vacancy_id' => 'vacancy_id', 'page' => 'page', 'per_page' => 'per_page', 'host' => 'host', 'locale' => 'locale', 'HH_User_Agent' => 'HH-User-Agent'];
