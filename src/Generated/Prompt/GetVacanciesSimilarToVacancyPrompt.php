...
/**
 * Класс данных запроса HeadHunter API [GET] /vacancies/{vacancy_id}/similar_vacancies.
 *
 * @documentation https://api.hh.ru/openapi/redoc#operation/get-vacancies-similar-to-vacancy
 */
class GetVacanciesSimilarToVacancyPrompt extends PrivatePrompt
{
    protected const METHOD = 'GET';

    protected const ENDPOINT = '/vacancies/{vacancy_id}/similar_vacancies';

    protected const CONTENT_TYPE = null;

    protected const QUERY_PARAMETER_STYLES = ['page' => ['style' => 'form', 'explode' => true], 'per_page' => ['style' => 'form', 'explode' => true], 'text' => ['style' => 'form', 'explode' => true], 'search_field' => ['style' => 'form', 'explode' => true], 'experience' => ['style' => 'form', 'explode' => true], 'employment' => ['style' => 'form', 'explode' => true], 'schedule' => ['style' => 'form', 'explode' => true], 'area' => ['style' => 'form', 'explode' => true], 'metro' => ['style' => 'form', 'explode' => true], 'professional_role' => ['style' => 'form', 'explode' => true], 'industry' => ['style' => 'form', 'explode' => true], 'employer_id' => ['style' => 'form', 'explode' => true], 'excluded_employer_id' => ['style' => 'form', 'explode' => true], 'currency' => ['style' => 'form', 'explode' => true], 'salary' => ['style' => 'form', 'explode' => true], 'label' => ['style' => 'form', 'explode' => true], 'only_with_salary' => ['style' => 'form', 'explode' => true], 'period' => ['style' => 'form', 'explode' => true], 'date_from' => ['style' => 'form', 'explode' => true], 'date_to' => ['style' => 'form', 'explode' => true], 'top_lat' => ['style' => 'form', 'explode' => true], 'bottom_lat' => ['style' => 'form', 'explode' => true], 'left_lng' => ['style' => 'form', 'explode' => true], 'right_lng' => ['style' => 'form', 'explode' => true], 'order_by' => ['style' => 'form', 'explode' => true], 'sort_point_lat' => ['style' => 'form', 'explode' => true], 'sort_point_lng' => ['style' => 'form', 'explode' => true], 'clusters' => ['style' => 'form', 'explode' => true], 'describe_arguments' => ['style' => 'form', 'explode' => true], 'no_magic' => ['style' => 'form', 'explode' => true], 'premium' => ['style' => 'form', 'explode' => true], 'responses_count_enabled' => ['style' => 'form', 'explode' => true], 'part_time' => ['style' => 'form', 'explode' => true], 'salary_frequency' => ['style' => 'form', 'explode' => true], 'salary_mode' => ['style' => 'form', 'explode' => true], 'employment_form' => ['style' => 'form', 'explode' => true], 'work_schedule_by_days' => ['style' => 'form', 'explode' => true], 'working_hours' => ['style' => 'form', 'explode' => true], 'work_format' => ['style' => 'form', 'explode' => true], 'education' => ['style' => 'form', 'explode' => true], 'driver_license_types' => ['style' => 'form', 'explode' => true], 'host' => ['style' => 'form', 'explode' => true], 'locale' => ['style' => 'form', 'explode' => true]];

    protected const FIELD_MAP = ['vacancy_id' => 'vacancy_id', 'page' => 'page', 'per_page' => 'per_page', 'text' => 'text', 'search_field' => 'search_field', 'experience' => 'experience', 'employment' => 'employment', 'schedule' => 'schedule', 'area' => 'area', 'metro' => 'metro', 'professional_role' => 'professional_role', 'industry' => 'industry', 'employer_id' => 'employer_id', 'excluded_employer_id' => 'excluded_employer_id', 'currency' => 'currency', 'salary' => 'salary', 'label' => 'label', 'only_with_salary' => 'only_with_salary', 'period' => 'period', 'date_from' => 'date_from', 'date_to' => 'date_to', 'top_lat' => 'top_lat', 'bottom_lat' => 'bottom_lat', 'left_lng' => 'left_lng', 'right_lng' => 'right_lng', 'order_by' => 'order_by', 'sort_point_lat' => 'sort_point_lat', 'sort_point_lng' => 'sort_point_lng', 'clusters' => 'clusters', 'describe_arguments' => 'describe_arguments', 'no_magic' => 'no_magic', 'premium' => 'premium', 'responses_count_enabled' => 'responses_count_enabled', 'part_time' => 'part_time', 'salary_frequency' => 'salary_frequency', 'salary_mode' => 'salary_mode', 'employment_form' => 'employment_form', 'work_schedule_by_days' => 'work_schedule_by_days', 'working_hours' => 'working_hours', 'work_format' => 'work_format', 'education' => 'education', 'driver_license_types' => 'driver_license_types', 'host' => 'host', 'locale' => 'locale', 'HH_User_Agent' => 'HH-User-Agent'];
    ...
    protected const QUERY_FIELDS = ['page', 'per_page', 'text', 'search_field', 'experience', 'employment', 'schedule', 'area', 'metro', 'professional_role', 'industry', 'employer_id', 'excluded_employer_id', 'currency', 'salary', 'label', 'only_with_salary', 'period', 'date_from', 'date_to', 'top_lat', 'bottom_lat', 'left_lng', 'right_lng', 'order_by', 'sort_point_lat', 'sort_point_lng', 'clusters', 'describe_arguments', 'no_magic', 'premium', 'responses_count_enabled', 'part_time', 'salary_frequency', 'salary_mode', 'employment_form', 'work_schedule_by_days', 'working_hours', 'work_format', 'education', 'driver_license_types', 'host', 'locale'];
 ...
 */
    ...
    /** @var string|null Идентификатор [работодателя](#tag/Rabotodatel), вакансии которого должны быть исключены из выдачи. Можно указать несколько значений
 */
    public ?string $excluded_employer_id = null;
 ...
 */
    ...
    /** @var bool|null Показывать вакансии только с указанием зарплаты. По умолчанию `false`
 ...
 */
    ...
    /** @var bool|null Возвращать ли [кластеры для данного поиска](#tag/Poisk-vakansij/Klastery-v-poiske-vakansij). По умолчанию — `false`
 */
    public ?bool $clusters = null;

    /** @var bool|null Возвращать ли описание использованных параметров поиска. Успешный ответ будет содержать поле [`arguments`]((#tag/Poisk-vakansij/operation/get-vacancies))).
По умолчанию — `false`
 */
    public ?bool $describe_arguments = null;

    /** @var bool|null Если значение `true` — автоматическое преобразование вакансий отключено. По умолчанию – false.
 ...
 */
    ...
    /** @var bool|null Если значение `true` — в сортировке вакансий будет учтены премиум вакансии. Такая сортировка используется на сайте. По умолчанию — false
 */
    public ?bool $premium = null;

    /** @var bool|null Если значение `true` — дополнительное поле `counters` с количеством откликов для вакансии включено. По-умолчанию — `false`
 */
