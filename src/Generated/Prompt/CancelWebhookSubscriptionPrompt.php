 ...
 */
class CancelWebhookSubscriptionPrompt extends PrivatePrompt
{
    ...
    protected const FIELD_MAP = ['subscription_id' => 'subscription_id', 'host' => 'host', 'locale' => 'locale', 'HH_User_Agent' => 'HH-User-Agent'];
