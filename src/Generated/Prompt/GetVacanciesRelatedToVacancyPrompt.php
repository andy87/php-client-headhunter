...
/**
 * Класс данных запроса HeadHunter API [GET] /vacancies/{vacancy_id}/related_vacancies.
 *
 * @documentation https://api.hh.ru/openapi/redoc#operation/get-vacancies-related-to-vacancy
 */
class GetVacanciesRelatedToVacancyPrompt extends PrivatePrompt
{
    protected const METHOD = 'GET';

    protected const ENDPOINT = '/vacancies/{vacancy_id}/related_vacancies';
