 ...
 */
class SearchForVacancyDraftDuplicatesPrompt extends PrivatePrompt
{
    protected const METHOD = 'GET';

    protected const ENDPOINT = '/vacancies/drafts/{draft_id}/duplicates';
    ...
    /** @var string Идентификатор черновика вакансии */
