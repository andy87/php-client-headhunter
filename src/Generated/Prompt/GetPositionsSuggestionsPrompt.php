 ...
 */
class GetPositionsSuggestionsPrompt extends PrivatePrompt
{
    protected const METHOD = 'GET';

    protected const ENDPOINT = '/suggests/positions';
    ...
    /** @var string Текст для поиска должности. Искомый текст должен быть длиной два или более символа и не более 3 000 символов */
    public string $text;
