...
/**
 * Класс данных запроса HeadHunter API [GET] /vacancies/{vacancy_id}/upgrades.
 *
 * @documentation https://api.hh.ru/openapi/redoc#operation/get-vacancy-upgrade-list
 */
class GetVacancyUpgradeListPrompt extends PrivatePrompt
{
    protected const METHOD = 'GET';

    protected const ENDPOINT = '/vacancies/{vacancy_id}/upgrades';

    protected const CONTENT_TYPE = null;

    protected const QUERY_PARAMETER_STYLES = ['host' => ['style' => 'form', 'explode' => true], 'locale' => ['style' => 'form', 'explode' => true]];

    protected const FIELD_MAP = ['vacancy_id' => 'vacancy_id', 'host' => 'host', 'locale' => 'locale', 'HH_User_Agent' => 'HH-User-Agent'];
