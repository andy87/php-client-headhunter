...
use Andy87\ClientsHh\Generated\Prompt\GetVacanciesRelatedToVacancyPrompt as BaseGetVacanciesRelatedToVacancyPrompt;
 ...
 * @property bool|null $describe_arguments Возвращать ли описание использованных параметров поиска. Успешный ответ будет содержать поле [`arguments`]((#tag/Poisk-vakansij/operation/get-vacancies)))
 ...
 */
class GetRelatedToVacancyPrompt extends BaseGetVacanciesRelatedToVacancyPrompt
{
}
